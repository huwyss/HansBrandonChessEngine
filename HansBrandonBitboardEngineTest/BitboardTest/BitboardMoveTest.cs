    ...
    public class BitboardMoveTest
    {
       ...
       [TestMethod]
        ...
        public void MoveTest_WhenKingSideCastling_ThenCorrectMove_White()
        {
            ...
            _target.Move(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0));
        ...
        public void MoveTest_WhenQueenSideCastling_ThenCorrectMove_White()
        {
            ...
            _target.Move(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0));
        ...
        public void MoveTest_WhenKingSideCastling_ThenCorrectMove_Black()
        {
            ...
            _target.Move(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.KingSide, 0));
        ...
        public void MoveTest_WhenQueenSideCastling_ThenCorrectMove_Black()
        {
            ...
            _target.Move(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.QueenSide, 0));
