...
namespace MantaChessEngineTest
{
    ...
    public class CastlingMoveTest
    {
        ...
        {
            IMove move = new CastlingMove(CastlingType.WhiteKingSide, new King(Definitions.ChessColor.White));
        ...
        {
            IMove move = new CastlingMove(CastlingType.BlackQueenSide, new King(Definitions.ChessColor.Black));
            string moveString = move.ToString();
        ...
        {
            IMove moveWhiteKingCastl = new CastlingMove(CastlingType.WhiteKingSide, new King(Definitions.ChessColor.White));
            IMove moveWhiteQueenCastl = new CastlingMove(CastlingType.WhiteQueenSide, new King(Definitions.ChessColor.White));
        ...
        {
            IMove moveBlackKingCastl = new CastlingMove(CastlingType.BlackKingSide, new King(Definitions.ChessColor.Black));
            IMove moveBlackKingCastl1 = new CastlingMove(CastlingType.BlackKingSide, new King(Definitions.ChessColor.Black));
