...
namespace HBConsole
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            HansBrandonEngine whiteEngine = new HansBrandonEngine(EngineType.MinimaxPosition, 256);
            whiteEngine.SetMaxSearchDepth(whiteLevel);
            HansBrandonEngine blackEngine = new HansBrandonEngine(EngineType.MinimaxPosition, 256);
        ...
        private static void PrintBoard(HansBrandonEngine engineRandom)
        {
