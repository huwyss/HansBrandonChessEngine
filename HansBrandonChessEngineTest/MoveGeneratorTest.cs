...
namespace HansBrandonChessEngineTest
{
    ...
    public class MoveGeneratorTest
    {
        ...
        public void GetMovesTest_WhenCastlingRightOk_ThenCastling()
        {
            ...
            Assert.AreEqual(true, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteKingSide, new King(ChessColor.White))), "e1g1. 0-0 castling missing");
            Assert.AreEqual(true, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteQueenSide, new King(ChessColor.White))), "e1c1. 0-0-0 castling missing");
        }
        ...
        public void GetMovesTest_WhenKingMoved_ThenNoCastling()
        {
            ...
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteKingSide, new King(ChessColor.White))), "e1g1. 0-0 castling not possible");
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteQueenSide, new King(ChessColor.White))), "e1c1. 0-0-0 castling not possible");
        }
        ...
        public void GetMovesTest_WhenCastlingBlockedQueenSide_ThenNoCastlingOnQueenSide()
        {
            ...
            var king = new King(ChessColor.White);
            List<IMove> kingMoves = king.GetMoves(target, board, Square.E1, true);
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteQueenSide, new King(ChessColor.White))), "0-0-0 castling not possible");
        }
        ...
        public void GetMovesTest_WhenNewKingFieldIsAttacked_ThenNoCastling()
        {
            ...
            var king = new King(ChessColor.White);
            List<IMove> kingMoves = king.GetMoves(target, board, Square.E1, true);
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteKingSide, new King(ChessColor.White))), "e1g1. 0-0 castling not possible. g1 is attacked.");
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteQueenSide, new King(ChessColor.White))), "e1c1. 0-0-0 castling not possible. c1 is attacked.");
        }
        ...
        public void GetMovesTest_WhenwhiteKingMoved_ThenCastlingRightLost()
        {
            ...
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteKingSide, new King(ChessColor.White))), "e1g1. 0-0 castling missing");
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteQueenSide, new King(ChessColor.White))), "e1c1. 0-0-0 castling missing");
        }
        ...
        public void GetMovesTest_WhenCastlingRightOk_ThenCastling_Black()
        {
            ...
            Assert.AreEqual(true, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackKingSide, new King(ChessColor.Black))), "e8g8. 0-0 castling missing");
            Assert.AreEqual(true, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackQueenSide, new King(ChessColor.Black))), "e8c8. 0-0-0 castling missing");
        }
        ...
        public void GetMovesTest_WhenKingMoved_ThenNoCastling_Black()
        {
            ...
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackKingSide, new King(ChessColor.Black))), "e1g1. 0-0 castling not possible");
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackQueenSide, new King(ChessColor.Black))), "e1c1. 0-0-0 castling not possible");
        }
        ...
        public void GetMovesTest_WhenFieldNextToKingAttacked_ThenNoCastling_Black()
        {
            ...
            var king = new King(ChessColor.Black);
            List<IMove> kingMoves = king.GetMoves(generator, board, Square.E8, true);
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackKingSide, new King(ChessColor.Black))), "e1g1. 0-0 castling not possible. f8 attacked");
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackQueenSide, new King(ChessColor.Black))), "e1c1. 0-0-0 castling not possible. d8 attacked");
        }
        ...
        public void GetMovesTest_WhenNewKingFieldAttacked_ThenNoCastling_Black()
        {
            ...
            var king = new King(ChessColor.Black);
            List<IMove> kingMoves = king.GetMoves(generator, board, Square.E8, true);
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackKingSide, new King(ChessColor.Black))), "e1g1. 0-0 castling not possible. g8 attacked");
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackQueenSide, new King(ChessColor.Black))), "e1c1. 0-0-0 castling not possible. c8 attacked");
        }
        ...
        public void GetMovesTest_WhenBlackKingMoved_ThenCastlingRightLost()
        {
            ...
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackKingSide, new King(ChessColor.Black))), "e8g8. 0-0 castling missing");
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackQueenSide, new King(ChessColor.Black))), "e8c8. 0-0-0 castling missing");
        }
        ...
        public void GetMovesTest_KiwipetePosition_WhenKingInCheck_ThenNoCastlingPossible()
        {
            ...
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackKingSide, new King(ChessColor.Black))), "e8g8. 0-0 castling not possible, king in check.");
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackQueenSide, new King(ChessColor.Black))), "e8c8. 0-0-0 castling not possible, king in check.");
        }
        ...
        public void GetMovesTest_KiwipetePosition_PawnAttacksFieldsNextToBlackKing_ThenNoCastlingPossible()
        {
            ...
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackKingSide, new King(ChessColor.Black))), "e8g8. 0-0 castling not possible. f8 attacked.");
            Assert.AreEqual(false, kingMoves.Contains(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackQueenSide, new King(ChessColor.Black))), "e8c8. 0-0-0 castling not possible. d8 attacked.");
        }
        ...
        {
            HansBrandonEngine engine = new HansBrandonEngine(EngineType.MinimaxPosition, 256);
            string position = "....rk.." +
                              "........" +
                              "........" +
                              "........" +
