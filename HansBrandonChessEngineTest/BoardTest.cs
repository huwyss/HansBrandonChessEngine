...
namespace HansBrandonChessEngineTest
{
    ...
    public class BoardTest
    {
        ...
        public void MoveTest_WhenKingSideCastling_ThenCorrectMove_White()
        {
            ...
            _target.Move(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteKingSide, new King(ChessColor.White)));
        ...
        public void MoveTest_WhenQueenSideCastling_ThenCorrectMove_White()
        {
            ...
            _target.Move(new CastlingMove(HansBrandonChessEngine.CastlingType.WhiteQueenSide, new King(ChessColor.White)));
        ...
        public void MoveTest_WhenKingSideCastling_ThenCorrectMove_Black()
        {
            ...
            _target.Move(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackKingSide, new King(ChessColor.Black)));
        ...
        public void MoveTest_WhenQueenSideCastling_ThenCorrectMove_Black()
        {
            ...
            _target.Move(new CastlingMove(HansBrandonChessEngine.CastlingType.BlackQueenSide, new King(ChessColor.Black)));
