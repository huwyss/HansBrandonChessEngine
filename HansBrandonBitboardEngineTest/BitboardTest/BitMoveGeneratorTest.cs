...
using HBCommon;
using HansBrandonChessEngine; // todo: remove this dependency later...
using System.Linq;
using Moq;
...
namespace HansBrandonBitboardEngineTest
{
    ...
    public class BitMoveGeneratorTest
    {
        ...
        public void GetMovesTest_WhenCastlingRightOk_ThenCastling()
        {
            ...
            Assert.AreEqual(2, moves.Count);
            Assert.IsTrue(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0)), "Ke1-g1 0-0 castling missing");
            Assert.IsTrue(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0)), "Ke1-c1 0-0-0 castling missing");
        }
        ...
        public void GetMovesTest_WhenKingMoved_ThenNoCastling()
        {
            ...
            Assert.AreEqual(0, moves.Count);
            Assert.AreEqual(false, moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0)), "Ke1-g1 0-0 castling not possible");
            Assert.AreEqual(false, moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0)), "Ke1-c1 0-0-0 castling not possible");
        }
        ...
        public void GetMovesTest_WhenCastlingBlockedKingSide_ThenNoCastlingOnKingSide()
        {
            ...
            Assert.AreEqual(1, moves.Count);
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0)), "Ke1-g1 0-0 castling not possible");
            Assert.IsTrue(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0)), "Ke1-c1 0-0-0 castling missing");
        }
        ...
        public void GetMovesTest_WhenCastlingBlockedQueenSide_ThenNoCastlingOnQueenSide()
        {
            ...
            Assert.AreEqual(1, moves.Count);
            Assert.IsTrue(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0)), "Ke1-g1 0-0 castling missing");
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0)), "Ke1-c1 0-0-0 castling not possible");
        }
        ...
        public void GetMovesTest_WhenFieldNextToKingIsAttacked_ThenNoCastling()
        {
            ...
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0)), "0-0 castling not possible");
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling not possible");
        }
        ...
        public void GetMovesTest_WhenNewKingFieldIsAttacked_ThenNoCastling()
        {
            ...
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0)), "0-0 castling not possible. g1 is attacked.");
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling not possible. c1 is attacked.");
        }
        ...
        public void GetMovesTest_WhenwhiteKingMoved_ThenCastlingRightLost()
        {
            ...
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0)), "0-0 castling not allowed");
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling not allowed");
        }
        ...
        public void GetMovesTest_WhenWhiteKingRookMoved_ThenCastlingRightKingSideLost()
        {
            ...
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0)), "0-0 castling not allowed");
            Assert.IsTrue(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling missing");
        }
        ...
        public void GetMovesTest_WhenWhiteQueenRookMoved_ThenCastlingRightQueenSideLost()
        {
            ...
            Assert.IsTrue(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.KingSide, 0)), "0-0 castling missing");
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.White, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling not allowed");
        }
        ...
        public void GetMovesTest_WhenCastlingRightOk_ThenCastling_Black()
        {
            ...
            Assert.AreEqual(2, moves.Count);
            Assert.IsTrue(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.KingSide, 0)), "Ke8-g8 0-0 castling missing");
            Assert.IsTrue(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.QueenSide, 0)), "Ke8-c8 0-0-0 castling missing");
        }
        ...
        public void GetMovesTest_WhenKingMoved_ThenNoCastling_Black()
        {
            ...
            Assert.AreEqual(0, moves.Count);
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.KingSide, 0)), "Ke8-g8 0-0 castling not possible");
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.QueenSide, 0)), "Ke8-c8 0-0-0 castling not possible");
        }
        ...
        public void GetMovesTest_WhenFieldNextToKingAttacked_ThenNoCastling_Black()
        {
            ...
            var moves = _bitMoveGenerator.GetCastling(ChessColor.Black).ToList();
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.KingSide, 0)), "0-0 castling not possible. f8 attacked");
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling not possible. d8 attacked");
        }
        ...
        public void GetMovesTest_WhenBlackKingMoved_ThenCastlingRightLost()
        {
            ...
            Assert.IsFalse(kingMoves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.KingSide, 0)), "0-0 castling not allowed as king already moved");
            Assert.IsFalse(kingMoves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling not allowed as king already moved");
        }
        ...
        public void GetMovesTest_WhenBlackKingRookMoved_ThenCastlingRightKingSideLost()
        {
            ...
            Assert.IsFalse(kingMoves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.KingSide, 0)), "0-0 castling not allowed as rook already moved");
            Assert.IsTrue(kingMoves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling missing");
        }
        ...
        public void GetMovesTest_WhenBlackQueenRookMoved_ThenCastlingRightQueenSideLost()
        {
            ...
            Assert.IsTrue(kingMoves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.KingSide, 0)), "0-0 castling missing");
            Assert.IsFalse(kingMoves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling not allowed as rook already moved");
        }
        ...
        public void GetMovesTest_KiwipetePosition_WhenKingInCheck_ThenNoCastlingPossible()
        {
            ...
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.KingSide, 0)), "0-0 castling not allowed. king in check.");
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling not allowed. king in check.");
        }
        ...
        public void GetMovesTest_KiwipetePosition_PawnAttacksFieldsNextToBlackKing_ThenNoCastlingPossible()
        {
            ...
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.KingSide, 0)), "0-0 castling not allowed. f8 is attacked.");
            Assert.IsFalse(moves.Contains(BitMove.CreateCastling(ChessColor.Black, HBCommon.CastlingType.QueenSide, 0)), "0-0-0 castling not allowed. d8 is attacked.");
        }
        ...
        {
            var engine = new HansBrandonBitboardEngine.HansBrandonBitboardEngine(256);
            string position = "....rk.." +
                              "........" +
                              "........" +
                              "........" +
