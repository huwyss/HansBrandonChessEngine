...
namespace HansBrandonChessEngine
{
    public class Board : IBoard
    {
        ...
        public void SetPiece(Piece piece, Square square)
        {
            if (piece == null)
            {
                throw new HansBrandonEngineException($"SetPiece called with null is not allowed! on square: {square}");
            }
        ...
        public void RemovePiece(Square square)
        {
            ...
            {
                throw new HansBrandonEngineException($"RemovePiece called but the square is already empty! square: {square}");
            }
